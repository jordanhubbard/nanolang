...
static int compile_file(const char *input_file, const char *output_file, CompilerOptions *opts) {
    ...
    char runtime_files[1536] = "src/runtime/list_int.cpp src/runtime/list_string.cpp src/runtime/list_token.cpp src/runtime/token_helpers.cpp src/runtime/gc.cpp src/runtime/dyn_array.cpp src/runtime/gc_struct.cpp src/runtime/nl_string.cpp src/runtime/cli.cpp";
