...
NvmFileRuntimeStatus nvm2c_emit_file_cyclic_bytes(const uint8_t *bytes, size_t size,
    ...
    } else status = file_cyclic_native_emit_serialized(bytes, size, FNE_PUBLIC, entry_identifier,
