 ...
 * STR_CONTAINS, CAST_STRING of i64. Anything else is refused with an error.
 ...
 * printing arrays/records, string arrays, and the rest of the string and
 * array libraries stay refused.
 */
