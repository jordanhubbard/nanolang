...
static bool build_obj_list(char *buf, size_t buf_size, const char *obj_dir, bool daemon) {
    ...
    static const char *nanoisa_objs[] = {
        "nanoisa/isa.o", "nanoisa/passive.o", "nanoisa/nvm_format.o",
        "nanoisa/affine_state.o", "nanoisa/ownership_contracts.o", "nanoisa/retained_layouts.o", "nanoisa/reference_places.o",
