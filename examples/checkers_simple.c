...
extern int64_t SDL_Init(int64_t flags);
extern void SDL_Quit();
extern const char* SDL_GetError();
extern void SDL_Delay(int64_t ms);
extern SDL_Window* SDL_CreateWindow(const char* title, int64_t x, int64_t y, int64_t w, int64_t h, int64_t flags);
extern void SDL_DestroyWindow(SDL_Window* window);
extern SDL_Renderer* SDL_CreateRenderer(SDL_Window* window, int64_t index, int64_t flags);
extern void SDL_DestroyRenderer(SDL_Renderer* renderer);
extern int64_t SDL_RenderClear(SDL_Renderer* renderer);
extern void SDL_RenderPresent(SDL_Renderer* renderer);
extern int64_t SDL_SetRenderDrawColor(SDL_Renderer* renderer, int64_t r, int64_t g, int64_t b, int64_t a);

int64_t nl_main();

int64_t nl_main() {
    int64_t result = SDL_Init(SDL_INIT_VIDEO);
    int64_t window = SDL_CreateWindow("Checkers Test", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640LL, 480LL, SDL_WINDOW_SHOWN);
    int64_t renderer = SDL_CreateRenderer((SDL_Window*)window, -1LL, SDL_RENDERER_ACCELERATED);
    SDL_SetRenderDrawColor((SDL_Renderer*)renderer, 255LL, 0LL, 0LL, 255LL);
