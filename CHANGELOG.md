...
- NanoISA v2 module container: 40-byte header with independent format and ISA versions, feature-bit negotiation, and a bounded 64-bit section directory. Not yet the default on-disk format; see `docs/superpowers/specs/2026-09-01-nanoisa-v2-module-format.md`.
