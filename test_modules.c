...
double nl_cos();
double nl_tan();
int64_t nl_str_length();
const char* nl_str_concat();
const char* nl_str_substring();
bool nl_str_contains();
bool nl_str_equals();
void nl_at();
int64_t nl_array_length();
int64_t* nl_array_new();
void nl_array_set();
const char* nl_getcwd();
const char* nl_getenv();
int64_t nl_char_at();
...
struct nl_list_token_pop();
struct nl_list_token_get();
void nl_list_token_set();
void nl_list_token_insert();
struct nl_list_token_remove();
