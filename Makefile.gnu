...
$(OBJ_DIR)/typechecker.o: $(SRC_DIR)/typechecker_nominal_arrays.inc $(SRC_DIR)/typechecker_purity.c $(SRC_DIR)/typechecker_passive.c $(SRC_DIR)/generated/purity_intrinsics.h
