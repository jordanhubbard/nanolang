...
test-nanoisa-src-nano: nanoisa_emit nano_virt nano_vm nvm2c nvm2c-runtime nanoisa_dump $(NANOISA_OBJECTS) $(NANOISA_UTF8)
	...
	@NANO_ARTIFACT_LDFLAGS="$(LDFLAGS)" python3 -m unittest -v tests.test_nanoisa_flat_records tests.test_nanoisa_artifact_imports tests.test_nanoisa_shadow_emitter tests.test_nanoisa_tuple_values
