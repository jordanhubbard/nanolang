...
# WASM SIMD128 vectorization tests
test-wasm-simd: build
	@echo "🔢 Testing WASM SIMD128 auto-vectorization..."
	@chmod +x tests/test_wasm_simd.sh
	@bash tests/test_wasm_simd.sh ./bin/nanoc $(INTERPRETER)
	@echo "✅ WASM SIMD128 tests passed"
