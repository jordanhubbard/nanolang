...
- [Forth 2012 Pins](FORTH_2012.md) - I pin the standard revision, test suites, Gforth differential, licensing, and the environmental contract. The session runtime includes dictionary headers and nested input sources. I do not claim conformance yet.
