...
root=Path('/tmp/nanolang-record-vm-qualified-15d1a');archive=Path('/tmp/nanolang-record-vm-15d1a-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-vm-15d1a-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-vm-15d1a-driver.py',str(root),'/tmp/nanolang-record-vm-15d1a-'+host],check=True,env=env)
