...
root=Path('/tmp/nanolang-record-vm-qualified-88ae0');archive=Path('/tmp/nanolang-record-vm-88ae0-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-vm-88ae0-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-vm-88ae0-driver.py',str(root),'/tmp/nanolang-record-vm-88ae0-'+host],check=True,env=env)
