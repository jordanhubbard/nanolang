...
root=Path('/tmp/nanolang-record-vm-qualified-4dc1c');archive=Path('/tmp/nanolang-record-vm-4dc1c-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-vm-4dc1c-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-vm-4dc1c-driver.py',str(root),'/tmp/nanolang-record-vm-4dc1c-'+host],check=True,env=env)
