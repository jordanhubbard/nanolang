...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-carrier-ac877-driver.py',str(root),'/tmp/nanolang-file-cyclic-carrier-ac877-puck'],check=True,env=env)
