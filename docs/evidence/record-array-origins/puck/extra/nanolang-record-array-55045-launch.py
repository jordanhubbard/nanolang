...
root=Path('/tmp/nanolang-record-array-qualified-55045');archive=Path('/tmp/nanolang-record-array-55045-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-array-55045-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-array-driver.py',str(root),'/tmp/nanolang-record-array-55045-'+host],check=True,env=env)
