...
root=Path('/tmp/nanolang-record-array-qualified-2e9fa');archive=Path('/tmp/nanolang-record-array-2e9fa-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-array-2e9fa-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-array-driver.py',str(root),'/tmp/nanolang-record-array-2e9fa-'+host],check=True,env=env)
