...
ccs=[('normal','/usr/bin/gcc',{})] if sys.platform!='darwin' else [('normal','/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang',{})]
...
steps=[('normal',['make','CC='+ccs[0][1],'test-nsi-file'],{})]
try:
