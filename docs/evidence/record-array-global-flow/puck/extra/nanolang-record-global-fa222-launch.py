...
root=Path('/tmp/nanolang-record-global-qualified-fa222');archive=Path('/tmp/nanolang-record-global-fa222-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-global-fa222-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-global-fa222-driver.py',str(root),'/tmp/nanolang-record-global-fa222-'+host],check=True,env=env)
