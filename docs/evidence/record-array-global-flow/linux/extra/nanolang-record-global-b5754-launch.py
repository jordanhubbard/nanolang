...
root=Path('/tmp/nanolang-record-global-qualified-b5754');archive=Path('/tmp/nanolang-record-global-b5754-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-global-b5754-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-global-b5754-driver.py',str(root),'/tmp/nanolang-record-global-b5754-'+host],check=True,env=env)
