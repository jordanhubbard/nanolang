...
root=Path('/tmp/nanolang-file-cyclic-hosted-46912'); archive=Path('/tmp/nanolang-file-cyclic-hosted-46912-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-hosted-46912-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-hosted-46912-driver.py',str(root),'/tmp/nanolang-file-cyclic-hosted-46912-puck'],check=True,env=env)
