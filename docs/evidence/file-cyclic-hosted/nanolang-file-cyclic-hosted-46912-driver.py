...
run('clang-ordinary',py+['tests.test_file_cyclic_hosted'],dict(base,NANO_FILE_CYCLIC_HOSTED_CC=shutil.which('clang'),NANO_FILE_CYCLIC_HOSTED_CFLAGS=clang_flags,NANO_FILE_CYCLIC_HOSTED_SANITIZERS='0'))
run('sanitizer',py+['tests.test_file_cyclic_hosted'],dict(base,NANO_FILE_CYCLIC_HOSTED_CC=os.environ['CARRIER_SAN_CC'],NANO_FILE_CYCLIC_HOSTED_CFLAGS=normal_flags,NANO_FILE_CYCLIC_HOSTED_SANITIZERS='1'))
if not darwin:run('clang-sanitizer',py+['tests.test_file_cyclic_hosted'],dict(base,NANO_FILE_CYCLIC_HOSTED_CC=shutil.which('clang'),NANO_FILE_CYCLIC_HOSTED_CFLAGS=clang_flags,NANO_FILE_CYCLIC_HOSTED_SANITIZERS='1'))
