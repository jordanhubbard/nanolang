...
root=pathlib.Path('/home/jkh/Src/nanolang-affine-full-3c728c437' if linux else '/private/tmp/nanolang-affine-full-3c728c437')
...
base=pathlib.Path(('/tmp/' if linux else '/private/tmp/')+'nanolang-affine-full-3c728-'+platform)
