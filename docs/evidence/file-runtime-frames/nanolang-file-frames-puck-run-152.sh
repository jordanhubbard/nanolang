...
export CARRIER_PHASES=setup,normal,opcodes,wrapper
python3 /tmp/nanolang-file-frames-gate-v2.py /tmp/nanolang-file-frames-152 /tmp/nanolang-file-frames-152-darwin
