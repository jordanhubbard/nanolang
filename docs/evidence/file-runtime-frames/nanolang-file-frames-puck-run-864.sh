...
export CARRIER_PHASES=normal,sanitizer,hosted,body,flow,values,opcodes,wrapper
python3 /tmp/nanolang-file-frames-gate-v2.py /tmp/nanolang-file-frames-864 /tmp/nanolang-file-frames-864-darwin
