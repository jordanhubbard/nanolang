...
report={'head':pin,'host':platform.node(),'platform':platform.platform(),'fixture_overlay':None,'matrix_mode':mode,'scope':'Selected generated native C ASan/UBSan and emitted native IR ASan when requested; ordinary LLVM/Wasm. Explicit target ABI corrected generated CAST_U8 native/LLVM/Wasm acceptance with inventoried first-build ordinary providers; source and reconstruction remain unimplemented','phases':[]};save('manifest.json',report)
