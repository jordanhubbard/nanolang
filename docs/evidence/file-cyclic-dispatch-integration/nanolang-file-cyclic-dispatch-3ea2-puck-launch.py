...
root=Path('/tmp/nanolang-file-cyclic-dispatch-3ea2'); archive=Path('/tmp/nanolang-file-cyclic-dispatch-3ea2-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-dispatch-3ea2-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-dispatch-3ea2-driver.py',str(root),'/tmp/nanolang-file-cyclic-dispatch-3ea2-puck'],check=True,env=env)
