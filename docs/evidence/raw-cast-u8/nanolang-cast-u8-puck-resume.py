...
# I resume after the retained dependency-selection failure.
...
selected=['/usr/bin/python3',cc,native,sys.executable,shutil.which('python3'),shutil.which('make'),shutil.which('ar'),shutil.which('ld'),shutil.which('perl'),shutil.which('git')]
...
phases=[('schema',['/usr/bin/python3','-m','unittest','-v','tests.test_nanoisa_schema'],120),('raw-ordinary',['make','test-cast-u8',*flags],300),('byte-neighbors',[sys.executable,'-m','unittest','-v','tests.test_scalar_u8'],900)]
