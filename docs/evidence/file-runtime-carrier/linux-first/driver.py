...
def tools():
 paths={n:shutil.which(n) for n in ('make','python3','ar','ld','gcc','clang')}
...
''')
run('setup',['make','-f','Makefile.gnu','-f',str(probe),'-j4','carrier-providers','nvm2c','nvm2llvm','nvm2hl','nano_virt'])
