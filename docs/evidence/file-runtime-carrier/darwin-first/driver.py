...
def inventory(extra=()):
 ...
 return entries
write('environment.json',{k:v for k,v in os.environ.items() if k in ('CC','CARRIER_SAN_CC','SDKROOT','LIBRARY_PATH','NMS_NATIVE_CLANG_FLAGS','PATH')})
...
run('wrapper',py+['tests.test_wrapper_publication'],common)
