...
source=pathlib.Path('/home/jkh/Src/nanolang-evaluator-exclusive-timing')
prior=pathlib.Path('/tmp/nanolang-record-lists-40870-linux-prepare')
out=pathlib.Path('/tmp/nanolang-exclusive-77226-linux');out.mkdir(exist_ok=False)
...
assert subprocess.check_output(['git','rev-parse','HEAD'],cwd=source,text=True).strip()=='77226ef6e078145e217170bce0d2bef9b24a6732'
