...
steps=[('darwin',['make','-j8','test-service-module'],{'NANO_SERVICE_MODULE_TEST_CC':'/opt/homebrew/opt/llvm/bin/clang'}),('adjacent',['make','test-nvm-v2-module','test-nvm-v2-convert','test-verifier-profiles'],{})]
try:
