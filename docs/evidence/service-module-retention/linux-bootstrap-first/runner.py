...
steps=[('bootstrap',['make','-j8','bootstrap'],{}),
 ('gcc',['make','-j8','test-service-module'],{'NANO_SERVICE_MODULE_TEST_CC':'/bin/gcc'}),
 ...
 ('adjacent',['make','test-service-bindings','test-nsi-file-plan','test-nvm-format-v2','test-nvm-v2-imports','test-nvm-v2-module','test-nvm-v2-convert','test-nvm-v2-endtoend','test-wrapper-gen','test-verifier-profiles'],{})]
try:
