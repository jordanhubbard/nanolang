...
steps=[('adjacent',['make','-j8','test-service-bindings','test-nsi-file-plan','test-nvm-format-v2','test-nvm-v2-imports','test-nvm-v2-module','test-nvm-v2-convert','test-nvm-v2-endtoend','test-wrapper-gen','test-verifier-profiles'],{})]
try:
