...
base={'FILE_INDIRECT_TARGETS_OBJECTS':filtered,'FILE_INDIRECT_TARGETS_LDFLAGS':values['LDFLAGS']}
...
run('ordinary',py+['tests.test_file_indirect_targets'],dict(base,NANO_FILE_INDIRECT_TARGETS_CC=os.environ['CC'],NANO_FILE_INDIRECT_TARGETS_CFLAGS=normal_flags))
run('clang-ordinary',py+['tests.test_file_indirect_targets'],dict(base,NANO_FILE_INDIRECT_TARGETS_CC=shutil.which('clang'),NANO_FILE_INDIRECT_TARGETS_CFLAGS=clang_flags))
run('sanitizer',py+['tests.test_file_indirect_targets'],dict(base,NANO_FILE_INDIRECT_TARGETS_CC=os.environ['CARRIER_SAN_CC'],NANO_FILE_INDIRECT_TARGETS_CFLAGS=normal_flags+sanitize))
if not darwin:run('clang-sanitizer',py+['tests.test_file_indirect_targets'],dict(base,NANO_FILE_INDIRECT_TARGETS_CC=shutil.which('clang'),NANO_FILE_INDIRECT_TARGETS_CFLAGS=clang_flags+sanitize))
