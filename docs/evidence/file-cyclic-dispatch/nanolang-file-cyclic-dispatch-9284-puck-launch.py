...
root=Path('/tmp/nanolang-file-cyclic-dispatch-9284'); archive=Path('/tmp/nanolang-file-cyclic-dispatch-9284-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-dispatch-9284-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-dispatch-9284-driver.py',str(root),'/tmp/nanolang-file-cyclic-dispatch-9284-puck'],check=True,env=env)
