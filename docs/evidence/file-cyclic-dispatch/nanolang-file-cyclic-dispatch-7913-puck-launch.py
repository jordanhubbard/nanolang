...
root=Path('/tmp/nanolang-file-cyclic-dispatch-7913'); archive=Path('/tmp/nanolang-file-cyclic-dispatch-7913-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-dispatch-7913-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-dispatch-7913-driver.py',str(root),'/tmp/nanolang-file-cyclic-dispatch-7913-puck'],check=True,env=env)
