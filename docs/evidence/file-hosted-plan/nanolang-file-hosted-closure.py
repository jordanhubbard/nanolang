...
def tools():
 ...
 paths['sanitizer']=shutil.which(os.environ.get('NANO_FILE_HOSTED_CC','gcc'))
...
steps=[('compiler',['make','-j4','bin/nanoc_c']),('module',['bin/nanoc_c','modules/nanoisa/mvp.nano','-o',str(report/'module-mvp')]),('module-run',[str(report/'module-mvp')]),('wrapper',['bin/nano_virt','tests/test_minimal.nano','-o',str(report/'wrapper')]),('wrapper-run',[str(report/'wrapper')])]
results=[]
