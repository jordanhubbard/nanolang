...
pin=git('rev-parse','HEAD');assert pin.startswith('446c41da4')
...
report={'head':pin,'host':platform.node(),'platform':platform.platform(),'scope':'Generated CAST_U8 native/LLVM/Wasm acceptance; source and reconstruction remain unimplemented','phases':[]};save('manifest.json',report)
