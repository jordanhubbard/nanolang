...
void nl_list_LexerToken_push(List_LexerToken *list, Token value);

/* Remove and return the last element */
Token nl_list_LexerToken_pop(List_LexerToken *list);

/* Insert an element at the specified index */
void nl_list_LexerToken_insert(List_LexerToken *list, int index, Token value);

/* Remove and return the element at the specified index */
Token nl_list_LexerToken_remove(List_LexerToken *list, int index);

/* Set the value at the specified index */
void nl_list_LexerToken_set(List_LexerToken *list, int index, Token value);

/* Get the value at the specified index */
Token nl_list_LexerToken_get(List_LexerToken *list, int index);
