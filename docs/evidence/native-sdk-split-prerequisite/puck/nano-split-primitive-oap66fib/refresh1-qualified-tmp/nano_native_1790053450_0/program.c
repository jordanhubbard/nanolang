...
/* User functions */
int64_t nl___nano_module_0_str_split(int64_t nl_value) {
#line 1 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh1-qualified.nano"
    return ((nl_value) + (1));
}


int64_t nl_probe() {
#line 5 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh1-qualified.nano"
...
int64_t nl_main() {
#line 7 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh1-qualified.nano"
    return nl_probe();
}
