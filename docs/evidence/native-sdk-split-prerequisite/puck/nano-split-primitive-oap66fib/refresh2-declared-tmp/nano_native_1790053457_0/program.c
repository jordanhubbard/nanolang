...
/* User functions */
int64_t __nl_declared_str_split(int64_t nl_value) {
#line 1 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-declared.nano"
    return ((nl_value) + (1));
}


int64_t nl_probe() {
#line 3 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-declared.nano"
...
int64_t nl_main() {
#line 5 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-declared.nano"
    return nl_probe();
}
