...
/* Module forward declarations: handled by C reference compiler */

/* Extern function declarations (not covered by headers) */

/* Function prototypes */
int64_t nl___nano_module_0_str_split(int64_t nl_value);
int64_t nl_probe();
int64_t nl_main();

/* User functions */
int64_t nl___nano_module_0_str_split(int64_t nl_value) {
#line 1 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-qualified.nano"
    return ((nl_value) + (1));
}


int64_t nl_probe() {
#line 5 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-qualified.nano"
    assert((nl___nano_module_0_str_split(41)) == (42));
#line 5 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-qualified.nano"
    return 0;
}
...
int64_t nl_main() {
#line 7 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-qualified.nano"
    return nl_probe();
}
...
int64_t ___module_function_count_split_provider(void) { return 1; }
const char* ___module_function_name_split_provider(int64_t idx) {
if (idx == 0) return "str_split";
(void)idx; return "";
}
int64_t ___module_struct_count_split_provider(void) { return 0; }
const char* ___module_struct_name_split_provider(int64_t idx) {
(void)idx; return "";
}
bool ___module_is_unsafe_split_provider(void) { return false; }
bool ___module_has_ffi_split_provider(void) { return false; }
const char* ___module_name_split_provider(void) { return "split_provider"; }
const char* ___module_path_split_provider(void) { return "/private/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/split-provider.nano"; }
