...
typedef int64_t (*nl_FnPtr_0)(int64_t);


/* Extern function declarations (not covered by headers) */

/* Function prototypes */
int64_t nl_increment(int64_t nl_value);
int64_t nl_probe();
int64_t nl_main();

/* User functions */
int64_t nl_increment(int64_t nl_value) {
#line 1 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-local.nano"
    return ((nl_value) + (1));
}


int64_t nl_probe() {
#line 4 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-local.nano"
    nl_FnPtr_0 nl_str_split = nl_increment;
#line 5 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-local.nano"
    assert((({ __auto_type _nl_push_fn_1 = nl_str_split; __auto_type _nl_push_arg_1_0 = 41; _nl_push_fn_1(_nl_push_arg_1_0); })) == (42));
#line 6 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-local.nano"
    return 0;
}


int64_t nl_main() {
#line 9 "/tmp/nanolang-split-d1e41-puck-evidence/nano-split-primitive-oap66fib/refresh2-local.nano"
    return nl_probe();
}
