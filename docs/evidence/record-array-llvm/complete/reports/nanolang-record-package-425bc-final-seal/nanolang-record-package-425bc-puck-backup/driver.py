...
shutil.copyfile(os.environ['PACKAGE_RETAIN_RUNNER'],controls/'retained-package.py')
run('package',[sys.executable,str(controls/'retained-package.py')],{'PYTHONPATH':str(root),'PACKAGE_ARTIFACTS':str(report/'package-artifacts')})
