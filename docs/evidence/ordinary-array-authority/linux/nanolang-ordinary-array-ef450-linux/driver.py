...
for name in ('ownership_contracts','ordinary_record_authority','nvm_v2_convert','nvm_v2_endtoend'):
 selected=[p for p in objects if name!='ordinary_record_authority' or Path(p).stem!='ownership_contracts']
 exe=controls/name
