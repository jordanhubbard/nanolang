...
export LSAN_OPTIONS=
export CARRIER_PHASES=setup,normal,sanitizer,frames,opcodes,wrapper
python3 /tmp/nanolang-file-private-vm-gate.py /tmp/nanolang-file-private-vm-cfb /tmp/nanolang-file-private-vm-cfb-darwin
