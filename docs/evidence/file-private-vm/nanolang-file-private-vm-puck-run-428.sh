...
export LSAN_OPTIONS=
export CARRIER_PHASES=setup,normal,frames,opcodes,wrapper
python3 /tmp/nanolang-file-private-vm-integrated-gate.py /tmp/nanolang-file-private-vm-428 /tmp/nanolang-file-private-vm-428-darwin
