...
source=pathlib.Path('/home/jkh/Src/nanolang-list-registry-shadow-timing')
prior=pathlib.Path('/tmp/nanolang-record-lists-40870-linux-prepare')
out=pathlib.Path('/tmp/nanolang-list-registry-3f0c-linux');out.mkdir(exist_ok=False)
...
assert subprocess.check_output(['git','rev-parse','HEAD'],cwd=source,text=True).strip()=='3f0ca4d788ad10722139f77f2eb89cd722d591b8'
