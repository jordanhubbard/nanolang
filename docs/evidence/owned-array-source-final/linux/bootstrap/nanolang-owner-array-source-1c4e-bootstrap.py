...
root=pathlib.Path('/home/jkh/Src/nanolang-owned-array-source-final')
out=pathlib.Path('/tmp/nanolang-owner-array-source-1c4e-bootstrap');out.mkdir(exist_ok=False)
