...
def phase(name,args,phase_env,timeout):
 ...
 return ok
if not phase('bootstrap',[make,'-j2','CC='+cc,'bootstrap'],env,1800):sys.exit(1)
...
dump('terminal.json',{'status':'PASS','pin':'32ade5b5d','configs':[x[0] for x in configs],'all_input_pairs_equal':True})
