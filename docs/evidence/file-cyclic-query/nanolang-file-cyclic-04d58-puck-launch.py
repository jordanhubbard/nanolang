...
root=Path('/tmp/nanolang-file-cyclic-04d58'); archive=Path('/tmp/nanolang-file-cyclic-04d58-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-04d58-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-486ba-driver.py',str(root),'/tmp/nanolang-file-cyclic-04d58-puck'],check=True,env=env)
