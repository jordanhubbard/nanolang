...
base={'FILE_CYCLIC_OBJECTS':filtered,'FILE_CYCLIC_LDFLAGS':values['LDFLAGS']}
...
run('ordinary',py+['tests.test_file_cyclic'],dict(base,NANO_FILE_CYCLIC_CC=os.environ['CC'],NANO_FILE_CYCLIC_CFLAGS=normal_flags))
run('clang-ordinary',py+['tests.test_file_cyclic'],dict(base,NANO_FILE_CYCLIC_CC=shutil.which('clang'),NANO_FILE_CYCLIC_CFLAGS=clang_flags))
run('sanitizer',py+['tests.test_file_cyclic'],dict(base,NANO_FILE_CYCLIC_CC=os.environ['CARRIER_SAN_CC'],NANO_FILE_CYCLIC_CFLAGS=normal_flags+sanitize))
if not darwin:run('clang-sanitizer',py+['tests.test_file_cyclic'],dict(base,NANO_FILE_CYCLIC_CC=shutil.which('clang'),NANO_FILE_CYCLIC_CFLAGS=clang_flags+sanitize))
