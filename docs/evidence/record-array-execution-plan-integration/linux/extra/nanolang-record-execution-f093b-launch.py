...
root=Path('/tmp/nanolang-record-execution-qualified-f093b');archive=Path('/tmp/nanolang-record-execution-f093b-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-execution-f093b-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-execution-f093b-driver.py',str(root),'/tmp/nanolang-record-execution-f093b-'+host],check=True,env=env)
