...
root=Path('/tmp/nanolang-record-execution-qualified-b87bb');archive=Path('/tmp/nanolang-record-execution-b87bb-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-execution-b87bb-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-execution-b87bb-driver.py',str(root),'/tmp/nanolang-record-execution-b87bb-'+host],check=True,env=env)
