...
root=Path('/tmp/nanolang-file-cyclic-public-aff3'); archive=Path('/tmp/nanolang-file-cyclic-public-aff3-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-public-aff3-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-public-aff3-driver.py',str(root),'/tmp/nanolang-file-cyclic-public-aff3-puck'],check=True,env=env)
