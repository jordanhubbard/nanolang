...
root=Path('/tmp/nanolang-file-cyclic-public-414c-config'); archive=Path('/tmp/nanolang-file-cyclic-public-414c-source.tar.gz')
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-public-414c-config-driver.py',str(root),'/tmp/nanolang-file-cyclic-public-414c-config-puck'],check=True,env=env)
