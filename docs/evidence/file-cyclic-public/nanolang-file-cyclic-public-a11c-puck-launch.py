...
root=Path('/tmp/nanolang-file-cyclic-public-a11c'); archive=Path('/tmp/nanolang-file-cyclic-public-a11c-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-public-a11c-source.json').read_text())
...
env['CARRIER_PHASES']='setup,configuration,clang-ordinary,sanitizer,private-cyclic-dispatch,carrier,core-values,cyclic,cyclic-hosted,private-vm,private-native,public,archive-boundary'
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-public-a11c-driver.py',str(root),'/tmp/nanolang-file-cyclic-public-a11c-puck'],check=True,env=env)
