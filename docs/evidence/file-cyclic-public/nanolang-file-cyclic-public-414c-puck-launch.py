...
root=Path('/tmp/nanolang-file-cyclic-public-414c'); archive=Path('/tmp/nanolang-file-cyclic-public-414c-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-public-414c-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-public-414c-driver.py',str(root),'/tmp/nanolang-file-cyclic-public-414c-puck'],check=True,env=env)
