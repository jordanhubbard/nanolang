...
runtime('private-cyclic-dispatch','tests.test_file_cyclic_dispatch',compiler,normal_flags,0)
...
run('indirect-hosted',py+['tests.test_file_indirect_hosted'],dict(FILE_INDIRECT_HOSTED_OBJECTS=values['ISA'],FILE_INDIRECT_HOSTED_LDFLAGS=values['LDFLAGS'],NANO_FILE_INDIRECT_HOSTED_CC=compiler,NANO_FILE_INDIRECT_HOSTED_CFLAGS=normal_flags,NANO_FILE_INDIRECT_HOSTED_SANITIZERS='0'))
