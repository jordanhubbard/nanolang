...
root=Path('/tmp/nanolang-file-cyclic-hosted-integration-881fc'); archive=Path('/tmp/nanolang-file-cyclic-hosted-integration-881fc-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-hosted-integration-881fc-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-hosted-integration-driver.py',str(root),'/tmp/nanolang-file-cyclic-hosted-integration-881fc-puck'],check=True,env=env)
