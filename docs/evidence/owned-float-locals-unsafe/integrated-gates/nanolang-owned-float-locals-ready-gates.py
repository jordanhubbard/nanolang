...
root=pathlib.Path('/home/jkh/Src/nanolang-owned-float-locals-ready');out=pathlib.Path('/tmp/nanolang-owned-float-locals-ready-gates');out.mkdir(exist_ok=False)
...
steps=[steps[0], ('focused-gcc',['python3','/tmp/nanolang-float-corrected-unittest.py',str(out/'focused-gcc-producers.json'),*focus],'/usr/bin/gcc'),*steps[2:]]
