...
root=pathlib.Path('/home/jkh/Src/nanolang-owned-float-after803');out=pathlib.Path('/tmp/nanolang-float-after803-runtime');out.mkdir(exist_ok=False)
...
steps=[('setup',['make','-j8','-f','Makefile.gnu','nano_vm','nvm2c','nanoisa_dump'],None),('runtime',['make','test-owned-binary64','test-nested-owned-results','test-owned-value-results'],None)]
