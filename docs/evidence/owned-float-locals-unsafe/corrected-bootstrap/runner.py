...
root=pathlib.Path('/home/jkh/Src/nanolang-owned-float-locals-corrected')
out=pathlib.Path('/tmp/nanolang-owned-float-locals-corrected-bootstrap');out.mkdir(exist_ok=False)
