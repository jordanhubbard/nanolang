...
run('hosted',py+['tests.test_file_hosted'],dict(FILE_HOSTED_OBJECTS=values['ISA'],FILE_HOSTED_LDFLAGS=values['LDFLAGS'],NANO_FILE_HOSTED_CC=compiler,NANO_FILE_HOSTED_CFLAGS=normal_flags,NANO_FILE_HOSTED_SANITIZERS='0'))
