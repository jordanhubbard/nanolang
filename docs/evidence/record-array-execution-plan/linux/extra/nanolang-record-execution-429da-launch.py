...
root=Path('/tmp/nanolang-record-execution-qualified-429da');archive=Path('/tmp/nanolang-record-execution-429da-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-execution-429da-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-execution-429da-driver.py',str(root),'/tmp/nanolang-record-execution-429da-'+host],check=True,env=env)
