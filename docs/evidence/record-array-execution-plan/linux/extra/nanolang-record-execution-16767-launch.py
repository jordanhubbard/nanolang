...
root=Path('/tmp/nanolang-record-execution-qualified-16767');archive=Path('/tmp/nanolang-record-execution-16767-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-execution-16767-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-execution-driver.py',str(root),'/tmp/nanolang-record-execution-16767-'+host],check=True,env=env)
