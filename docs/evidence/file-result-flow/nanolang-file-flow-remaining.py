...
if os.environ.get('FLOW_REMAINING'):
 steps=[('clang',['make','test-file-flow-sanitizers']),('adjacent',['make','test-file-nominal','test-service-bindings']),('provider',['make','-j4','nano_virt'])]
results=[]
