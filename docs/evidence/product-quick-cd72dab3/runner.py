...
root=pathlib.Path('/home/jkh/Src/nanolang-product-owned-integration')
out=pathlib.Path('/tmp/nanolang-product-quick-cd72dab3');out.mkdir(exist_ok=False)
expected='cd72dab32f03f0817cffcf1527e75e8a3482f534'
