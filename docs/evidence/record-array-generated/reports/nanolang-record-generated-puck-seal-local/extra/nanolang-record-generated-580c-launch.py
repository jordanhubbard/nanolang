...
root=Path('/tmp/nanolang-record-generated-qualified-580c');archive=Path('/tmp/nanolang-record-generated-580c-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-generated-580c-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-generated-580c-driver.py',str(root),'/tmp/nanolang-record-generated-580c-'+host],check=True,env=env)
