...
root=Path('/tmp/nanolang-record-generated-qualified-4fd32');archive=Path('/tmp/nanolang-record-generated-4fd32-source.tar.gz');manifest=json.loads(Path('/tmp/nanolang-record-generated-4fd32-source.json').read_text())
...
subprocess.run([sys.executable,'/tmp/nanolang-record-generated-4fd32-driver.py',str(root),'/tmp/nanolang-record-generated-4fd32-'+host],check=True,env=env)
