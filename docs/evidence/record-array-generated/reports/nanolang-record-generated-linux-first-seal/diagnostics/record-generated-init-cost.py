...
art=Path('/tmp/nanolang-record-generated-init-cost');art.mkdir(exist_ok=False)
...
for name,cc,flags in configs:
 ...
 t.command(name+'-runtime',cc+base+flags+['-DRA_ALLOC_WRAP','-include','tests/nanoisa/record_array_alloc.h','-c','src/nanoisa/record_array_generated_private.c','-o',str(runtime)])
