...
root=Path('/tmp/nanolang-file-cyclic-carrier-5c71'); archive=Path('/tmp/nanolang-file-cyclic-carrier-5c71-source.tar.gz')
manifest=json.loads(Path('/tmp/nanolang-file-cyclic-carrier-5c71-source.json').read_text())
...
subprocess.run(['/opt/homebrew/bin/python3','/tmp/nanolang-file-cyclic-carrier-integration-driver.py',str(root),'/tmp/nanolang-file-cyclic-carrier-5c71-puck'],check=True,env=env)
