...
mode=evidence/'switch.mk'; mode.write_text('override CFLAGS += -DNANO_NO_COMPUTED_GOTO\n')
for name,cmd in [('switch',['make','-f','GNUmakefile','-f',str(mode),'-j2','OBJ_DIR=obj-switch-corrected','test-nanovm'])]:
