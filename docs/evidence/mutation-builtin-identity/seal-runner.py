...
assert all(d.is_dir() for d in fixtures)
...
shutil.copy2('/tmp/nanolang-seal-mutation-identity-first.py',out/'seal-first-runner.py')
shutil.copy2('/tmp/nanolang-mutation-seal-first-terminal.txt',out/'seal-first-terminal.txt')
