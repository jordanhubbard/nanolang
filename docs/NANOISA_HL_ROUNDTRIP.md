...
int comparisons, exact wrapping I64 addition/subtraction/negation/multiplication, guarded signed division/remainder, masked integer shifts, integer bitwise operations, boolean operators,
