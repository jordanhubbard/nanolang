...
10. **[NanoISA Virtual Machine](NANOISA.md)** - My VM backend
    ...
    - [5.1 One IR](NANOISA_ONLY.md) — verified `.nvm` is my portable compiler product; C11/LLVM/Wasm are translators. The C implementation remains my bootstrap seed, not a second product IR.

10.0. **[NanoLang 5.1](RELEASE_5.1.md)** - Current public One IR release notes (`v5.1.0`)
    - [NanoLang 5.0](RELEASE_5.0.md) — historical language/runtime cut and its unfinished architecture boundary
    - [NanoLang 4.5](RELEASE_4.5.md) — historical release covering 4.1–4.5
