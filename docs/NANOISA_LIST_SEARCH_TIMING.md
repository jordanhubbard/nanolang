...
I reapply this identical observer to8028ab194 after its uninstrumented Linux
bootstrap reaches the same ten-second limit. The new run has separate source/
provider/product maps and one120-second outer command; all original graph
inputs and deadlines remain. I do not infer improvement before measurement.
