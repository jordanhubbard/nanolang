...
- [ ] I reconstruct exact int/bool casts and eager generic boolean operations (`task_6426a39bec8f48db8dd2649fd979d687`, parent4bd034). I preserve nonzero/0-or-1 semantics, operand snapshots, typed BOOL checks, other-tag refusal and prior output. I require small independent truth tables, endpoint/call/loop parity and pinned GCC/Clang producer gates; blocked carry679 remains separate. [Preimplementation contract](NANOISA_RECONSTRUCT_TRUTHINESS.md).
