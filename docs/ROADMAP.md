...
- [ ] I retain no invented integer facts for absent union payload slots in native classification. I preserve exact present-field kinds and runtime checks while testing empty/data variant calls and returns in both orders against VM execution. Contract `docs/NATIVE_UNION_PADDING_FACTS.md`; MAC `task_a4b730306b84428da1f4e5683697353f`.
