...
- [ ] I complete native scalar ROT3 transport (`task_18ca25c8fc294c81b1a662fd22fc411b`), preserving VM stack order and parallel type/shape/provenance metadata. A fresh valid reconstruction fixture is refused before native output at opcode0x0A; `/tmp/nanolang-reconstruct-rot3-gcc.log` is retained. This is a separate paired-native prerequisite, not a VM or reconstruction execution failure.
