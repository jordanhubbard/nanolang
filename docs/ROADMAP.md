...
- [ ] I qualify the separate public C expression/options portability boundary (`task_6ade6d62ef644390bb9645b15077c8df`). Static audit finds GNU AST_BLOCK expressions despite the C99/C11 description and unqualified option/closure documentation; I require an actual inventory and portable lowering or checked refusals. Passing bounded scalar arithmetic does not establish whole-target conformance.
...
- [ ] I diagnose and repair the independently missing native-shadow array_slice lowering (`task_c9927df8c5674cf3bcf6ecdf7032f505`). The internal DFS data-structure correction does not qualify general slice source behavior. I require fresh exact C-seed/Stage1/Stage2 route evidence and an explicit supported contract before release completion.
...
- [x] I qualify reached public C record spread checked refusal under task_9eb3251d63eb48668b67755d9fea851b without adding a copy ABI: reviewed c285e1f0, canonical integration and frozen9cc7b06c, focused3/3 GCC/Clang, adjacent63/63 each and seven programs. Both publication APIs recover and explicit-field records execute under strict C99/C11. I retain 54 file, three compiler and six log identities in `docs/evidence/public-c-record-spread.json`; canonical merge still precedes MAC completion and original6ade final inventory.
