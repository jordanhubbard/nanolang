...
- [ ] I complete the exact source reduce checker/legacy dispatch child (`task_8618bac3cb6a42448c0066867deaed69`, parentd099) under [my contract](NANOISA_SCALAR_REDUCE_CONTRACT.md). I add narrow first-error emission propagation and driver checks because existing raw C publication cannot enforce unsupported-signature output preservation. I preserve bindings, exact fn(A,E)->A, ordered evaluation and existing homogeneous helpers, then require fresh bootstrap and new ordinary acceptance; canonical FUNCREF stays separately open.
