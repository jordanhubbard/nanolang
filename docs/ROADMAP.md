...
- [ ] I resolve bit-observable binary64 arithmetic before reconstruction admission (`task_50090616040044dfa3bba1ab93a9f6d1`, parent `task_4bd034f6029b7458201db74e2c3aeb32`). My [static audit and policy options](NANOISA_BINARY64_ARITHMETIC_POLICY.md) identify host-selected NaN result bits with no canonical payload contract, compare nondeterministic/canonical/payload-selection options, and recommend an explicitly reviewed canonical scalar arithmetic NaN policy preserving input/transport/negation bits, default rounding and total zero division. I require route inventory and coordinated source/VM/native/LLVM/Wasm exact-bit qualification before arithmetic admission; no temporary F64_TO_BITS ban or silent semantic change. Full parent remains open.
