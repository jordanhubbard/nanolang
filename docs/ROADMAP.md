...
- [ ] I guard ordinary VM STRUCT_NEW allocation before publication, using static repair followed by fresh ordinary lifecycle/fault acceptance (task_66983a5c5f9a4c869fc726824cf6a773). STRUCT_LITERAL/AGG_PACK already check allocation; I do not replay a failed artifact ([contract](NANOISA_STRUCT_NEW_ALLOCATION.md)).
