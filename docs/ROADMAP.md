...
I retain reviewed source short-circuit qualification in `docs/evidence/nanovirt-source-short-circuit.md`: corrected three focused methods and91 codegen checks pass, plus external public C lifting five methods under GCC/Clang. Tasks0b335 and5772 await canonical merge; selfhost6e16 and public C lifting remain separate.
