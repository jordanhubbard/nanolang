...
- [x] I resolve my Darwin Forth core gate timeout recorded by stopped task
      `task_1b914e18e8c830e9db6fcb2be90e73b1` through replacement task
      `task_560e50b04c0a7a5a33537b0bc5292ed1`. At frozen product `ece241ba`,
      the configured 600-second alarm fired after the file-source Core test
      inherited terminal input. My corrected harness supplies deterministic
      EOF without changing production Forth or the deadline. The same compiler
      source passes the complete Darwin `make -j8 test-quick` gate under a PTY
      in 985.04 seconds. [Corrected evidence](evidence/product-acceptance-ece241ba-darwin-corrected.txt).
      Full release acceptance remains open.
