...
- [ ] **Public pure module facts** (`task_0c5b59e1670049729c5216eadc444213`): I preserve pub across parser-supported pure fn and pure extern fn modifiers when collecting module exports. Scanner shadows retain private/exported identities, ordering, FFI facts and body isolation; ordinary canonical VM/native checks verify counts and indexed names. This product-stacked repair remains pending actual main integration and makes no dd74 attribution.
