...
- [ ] I require instantiated module constants before every owned VM core activation and resume (`task_a468c371da11fb8a37a9567bb7f0af21`). I preserve ordinary module fallback and retain the checked `PUSH_STR` decode refusal as defense in depth. Direct public-core entry, proof-invalidated PRINT resumption and public invocation must refuse before an owned activation when the active constant table is incomplete.
