...
- [ ] I resolve structured `.par_begin`, `.par_node`, and `.par_end` assembly markers into authoritative version-2 record offsets, preserving canonical bytes and verifier checks (`task_6798838c50b74d698505602f06b70194`).
