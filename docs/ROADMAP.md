...
- [ ] I preserve exact primitive-format fixture input bits (`task_24e26c8c12f34eb3958f41e7192b6797`). Darwin18255183 passes35 methods, then exposes a sibling reference consumer still emitting host `%a` NaN literals. I retain the failed report, use integer bit transport for both conversions, and preserve all64 expected values and cleanup assertions before repeating the full71 gate.
