...
- [ ] I resume public C scalar policy locally under `task_54c918adf5c04bb78e420c5881c95e82`, preserving failed parent070db worker/FFI evidence. My [staged contract](PUBLIC_C_BINARY64_CONTRACT.md) precedes production: output-preserving publication and exact scalar planning; exact bit constants/intrinsics plus C99/C11 ordered shared arithmetic; ordered scalar globals/hosted entry; frozen GCC/Clang and paired source gates. I do not reuse claimed worker passes or silently substitute GNU legacy emission.
...
- [ ] I preserve declared record and selected-variant scalar field types in my public C backend under local child `task_54c918adf5c04bb78e420c5881c95e82`; my adjacent suite retained five passes and two checked unknown-field refusals at33ffb28e (`/tmp/nanolang-public-c-adjacent-backend.log`). I recover exact owner metadata, preserve unknown refusal, and require existing match plus FLOAT field controls before closing.
