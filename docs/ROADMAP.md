...
- [x] I preserve U8 results across non-self native tail calls (`task_9eb8a1d54fc441f582b180b398ac0a08`). I add the existing boxed U8 carrier to the result-assignment whitelist while retaining exact return checks and cleanup. All256 values pass two tail relays in both declaration orders, with self-tail and wrong-tag controls; three GCC and24Clang sanitizer methods pass. [Contract and evidence](NATIVE_U8_TAIL_RESULTS.md).
