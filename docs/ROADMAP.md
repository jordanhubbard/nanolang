...
- [ ] I resolve the cross-host signed-NaN formatting discrepancy (`task_e92a45b66a104e9ba3854cd5f994df8b`). My f736 Darwin full-managed gate passes18 methods, then fails the exact negative-NaN reference at index28. I retain the failed report and unchanged hashes, measure fresh native spellings, then explicitly define portable sign handling and qualify VM/managed/native/source conversion routes without weakening NaN assertions. The full Darwin gate remains failed.
