...
- [ ] I preserve public C complete exact-match termination (`task_b0351cb144594a3ca8a66a415e903242`, prerequisitef578). My [contract](PUBLIC_C_MATCH_PAYLOAD_CONTRACT.md#my-exact-complete-match-termination-prerequisite) retains strict missing-return failures in unchanged05/06 fixtures, requires exact unguarded unique complete variant coverage before adding a controlled terminal else, and excludes partial/guarded/wildcard assumptions. No warning suppression or guessed return value qualifies this gate.
