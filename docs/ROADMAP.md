...
- [ ] I qualify instrumented owned call-graph execution (`task_5b3e7272ec3f4ae9ad8eb8ffb15a3565`) before claiming the remaining PR725 gate: O0/O2 full runs reach600 seconds, partition preambles/cases0 and1 reach300 seconds, and current-process ptrace sampling is denied. I retain complete ordinary/native results separately, stop further launches, audit tool configuration and localize bounded ordinary execution with phase evidence before any repair. Elapsed time alone establishes no runtime or instrumentation defect. [Evidence](evidence/owned-value-call-graphs.md).
