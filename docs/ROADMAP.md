...
- [ ] I lower the core Shape and Option union examples with declared payload identity (`task_9a12d05fafaf4f92bea5919683f9ba32`). My full product gate at 2c2f6f52 records this refusal in [current acceptance](evidence/product-acceptance-2c2f6f52.md).
...
- [ ] I link the declared filesystem symbols and array results used by core examples (`task_2e5ed27f56c44ca7b2f16385a6a15747`). My full product gate at 2c2f6f52 records this refusal in [current acceptance](evidence/product-acceptance-2c2f6f52.md).
