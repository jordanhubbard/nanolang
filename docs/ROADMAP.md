...
- [ ] I preserve declared single-letter enum names in native C output (`task_fc3046bc294543ca837fcb4ca21298c3`). Static inspection shows enum definition emission still calls the free-variable name fallback; my bounded union snapshot does not cover enums. I require fresh ordinary enum acceptance and unchanged foreign/runtime/generic boundaries before completion.
