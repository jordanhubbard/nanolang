...
- [ ] I resolve structured `flow` producer markers with explicit source IDs and dependency sets into existing version-2 passive records, preserving stable serial order, canonical bytes and verifier semantics (`task_d83213c008654ff4a561843889e778aa`; planned contract in `docs/NANOISA_PASSIVE.md`). Frontend `flow` syntax and broader input proofs remain separate.
