...
- [ ] I preserve exact public C union-valued function returns (`task_81069872995f49a4a8d8a38a386b2c27`, parent6ade). Static emit_function/forward declarations name struct results but route TYPE_UNION through default int64_t; constructor expressions retain their nominal union type. I require an exact nominal result/call contract and ordinary execution/refusal gates before repair; named payload representation does not close this boundary.
