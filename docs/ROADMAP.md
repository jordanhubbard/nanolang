...
- [ ] I preserve int64 language calls to main while exposing a hosted C int wrapper in public C child54c918. Static review found direct signature narrowing before publication; I require private declaration/call/reference mapping, lexical shadow preservation, initializer reentry and a high-bit result observer. I retain the initial six-of-seven gate and its isolated missing-passive-helper link failure separately; no failed binary ran.

- [ ] I preserve declared record and selected-variant scalar field types in my public C backend under local child `task_54c918adf5c04bb78e420c5881c95e82`; my adjacent suite retained five passes and two checked unknown-field refusals at33ffb28e (`/tmp/nanolang-public-c-adjacent-backend.log`). I consume checked annotations or exact scoped declaration metadata and retain explicit UNKNOWN. My [public C evidence](evidence/public-c-binary64.md) passes eight GCC/Clang methods and all seven existing programs; canonical merge precedes closure.
