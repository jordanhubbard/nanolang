...
- [ ] I retain strict native C compilation of my existing range fixture (`task_3d5492ef63924b4d91a11364a80fde83`). The range-arity gate reaches verified seed VM execution, then GCC refuses generated unused branch labels before native execution. I preserve `/tmp/nanolang-range-arity-paired.log`; correct label emission without weakening warnings, branch flow or joins, then qualify the unchanged paired fixture and adjacent native gates.
...
- [ ] I reconstruct exact scalar ROT3 (`task_866bb67bb82f43e6ad996e741286189f`): VM order `a b c -> c a b`, immutable evaluation snapshots, ordinary mixed-tag/call/loop parity and underflow refusal preserving output. [Contract](NANOISA_RECONSTRUCT_ROT3.md); full reconstruction remains open.
