...
- [ ] **Reference parameter and root contracts.** I preserve complete/resource
  ...
  - [ ] I validate signature/count/layout agreement and retain the contracts
        across codec, execution-module bridge and canonical reconstruction.
  - [ ] I test ordinary typed-root transport plus reference retention/refusal;
        runtime admission still requires instruction-level lifetime/ownership
        verification and genuine reference lowering, not metadata alone.
