...
- [ ] I execute explicit parser, typechecker and transpiler assertions from my component driver entry points (`task_ab449a7054904fb9a531ee9c35aa78d9`). My stage3 runner currently labels empty/library-load drivers as tests; I replace those drivers with deterministic public-API checks and report their bounded scope. I require freshly compiled drivers and executed assertions, without claiming that all imported shadows ran. The broader component audit `task_56a065134a6e4394ae5c307c05e9597d` remains open. [Contract](COMPONENT_ENTRY_ASSERTIONS.md).
