...
- [ ] I complete native exact INT/BOOL ROT3 (`task_18ca25c8fc294c81b1a662fd22fc411b`) with complete classifier metadata permutation and immutable emitter slots, guarded underflow, excluded-kind output preservation and ordinary VM/GCC/Clang parity. [Contract](NATIVE_SCALAR_ROT3.md); wider tags remain excluded.
