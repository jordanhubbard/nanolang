...
- [ ] I admit lexical int/bool declarations in borrowed-source control flow after definite-initialization analysis, preserving initializer order, lexical restoration, names, shadows and paired VM/native execution (MAC `task_d3fdac5a43784608851272407743977b`). My [lexical contract](NANOISA_SOURCE_BORROW_LEXICAL_SCALARS.md) retains unique physical slots, initializer-before-binding order and lexical advisory intervals. Resource moves and early exits remain separate.
