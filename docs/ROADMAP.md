...
- [ ] I preserve every owned-string admission boundary before PR750 merge (`task_64394f8214c3eb7bd28ebc7e2333ce6d`). Independent static review finds instantiated-constant readiness confined to the fast proof path and shared string-print opcodes widening the separate borrowed profile. I require exact fallback/public-core and profile refusal controls, precise per-trap proof evidence and allocation claims limited to instrumented sites. I retain the [review hold](https://github.com/jordanhubbard/nanolang/pull/750#issuecomment-5732726734); source admission and product522 remain blocked on corrected qualification.
