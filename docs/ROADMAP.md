...
- [ ] I repair public C concat ownership and operand order (`task_c075a8783181411d89c63a2e6f1950b0`, parent6ade), after integer conversion. Static allocation/size checks and tracking are absent; C argument order is unspecified. I require a separate checked ownership/ordering contract and ordinary alias/failure controls; expression blocks, match typeof, option/capture acceptance and whole portability remain open as inventoried.
