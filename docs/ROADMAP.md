...
- [ ] I retain scalar let-only `flow` source identities, derive forward/diamond dependencies and stable lowest-ready serial order in both frontends, and compare exact emitted records and backend results (`task_a1bedc94472e491ea40ae8773f3b7ca0`; planned contract in `docs/NANOISA_PASSIVE.md`). Unsupported captures/effects remain refused; scalar ABI/calculator work stays separate.
