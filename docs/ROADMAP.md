...
- [ ] I preserve exact float-array source/native transport (`task_ef670a36b03a4df388594c8f1500bd85`, prerequisite of `task_2578ab8cd0e2406786ba38bde307f4a4`). I keep float element identity distinct from integer/bool arrays through constructors, reads/writes, locals, calls, returns and roots. I retain double payloads, aliases, checked bounds and cleanup; I test same-module VM/native behavior with GCC/Clang sanitizers and ordinary source acceptance. Functional filter/map/reduce lowering remains under `task_c83543611db54102b1f75f7a94f9e93d`; parent2578 stays open until its core filter criterion passes. [Contract](NATIVE_FLOAT_ARRAYS.md).
