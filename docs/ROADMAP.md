...
Compiler product:
- [ ] I restore trial-deleted child counts for newly deferred VM cycle roots
      ...
      Existing positive lifecycle/collector checks must pass; the complete
      compiler assertion remains independently open under `task_fdf43892a1104b1facddc2553af390af`.
