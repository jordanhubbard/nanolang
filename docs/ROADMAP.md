...
- [ ] I admit exact single-owner consuming source calls (`task_c5208ffb6e494d7691ba9089c6a8e208`) after merged runtime4ef/PR709. My [contract](NANOISA_SOURCE_CONSUMING_CALLS.md) orders resource-parameter profile routing, live mode-zero helper ownership and whole-owner CALL lowering before paired C-seed/Stage1/Stage2 metadata, shadow, VM/native and refusal gates; mixed signatures and full ownership remain separate.
