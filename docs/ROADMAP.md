...
- [ ] I restore exact public C builtin str_length result inference (`task_66f75e0c3cd74d2989d158237c7be305`, prerequisite3a041). My [recorded contract](PUBLIC_C_INT_CONVERSION_CONTRACT.md#my-exact-string-length-prerequisite) retains the unchanged03_strings checked refusal and requires exact STRING-to-INT inference/emission with binding precedence, prior-output preservation and fresh integration gates. I do not replace unknown types with guessed INT.
