...
- [ ] I preserve exact STRING EQ/NE in public C (`task_4c6d924e0aa242df950f662f61981664`, parent6ade). Fresh signed-formatting fixtures exposed raw pointer equality in generated assertions at9a5e1f8a. I retain original source/logs, require exact value comparison with once-only ordered operands and sanitizer/output-preservation controls, and do not attribute pointer assertions to formatting bytes.
