...
- [ ] **Packed scalar array core** (`task_bdaf1bb74e9749bf8cc1ccaad21af56c`): I preserve declared scalar tags and the three explicit portable VM coercions, without opcode admission ([contract](NANOISA_MANAGED_PACKED_SCALARS.md)). Raw union-member fallbacks remain an unresolved VM semantics/shape obligation; I do not infer portability from one host.
