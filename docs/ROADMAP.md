...
- [ ] I reconstruct exact signed/unsigned wide multiplication (`task_684295d1eb064fecb03685bf65bb0697`, parent4bd034): bounded base-65536 limb convolution, total signed correction, immutable low/high snapshots and fresh small ordinary VM/C/Nano acceptance with known successful compiler pins. I preserve strict refusals and prior output; historical679 artifacts and compiler selections remain excluded. [Preimplementation contract](NANOISA_RECONSTRUCT_WIDE_MULTIPLY.md).
