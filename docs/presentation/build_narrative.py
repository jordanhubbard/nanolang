...
def build() -> Path:
    ...
    paragraph(document, "At compiler-source pin 43cbec85b, the initial module and two successive NanoVM compiler generations produced identical 850,160-byte modules with SHA-256 f20f5cc3bb9923a87ead6961f82f7427162210ad90e0e283d3264385a2a943bb. Both generations verified, and the second compiled, verified and executed hello. This raw fixed point is reproducibility evidence; it does not prove compiler correctness.")
    paragraph(document, "At the same pin, two successive standalone native compiler generations produced identical 850,160-byte modules with SHA-256 1aa25246e1153f5bdf575c926ce04aa391cf0a7fa418a8c87f015dda1137e356. They took 3,079.720 and 3,183.199 seconds, verified, retained the same five-library host closure and compiled a verified, executing hello. Their raw hash differs from the NanoVM route because the retained absolute private-library paths differ; I do not normalize them.")
