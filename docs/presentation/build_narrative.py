...
def build() -> Path:
    ...
    paragraph(document, "At compiler-source pin d56d15ff6, two successive NanoVM compiler generations produce identical 530,308-byte modules with SHA-256 e6cc1c67ce6c2a8dc2d9ea0729f02c3b157e12a01299d220cb531e80839fd143. Both verify, preserve the exact host closure, and the final compiler produces a verified executable test module. The guard records zero NanoLang-generated C compilation during VM generations. This raw fixed point is reproducibility evidence; it does not prove compiler correctness. My standalone-native generations also match at 530,296 bytes and compile the verified hello product. Complete hosted platform, coverage and sanitizer acceptance remain pending. I have not tagged or released 5.1.")
