...
int main(void) {
    ...
    struct_auxiliary_teardown_controls(); registration_controls(); view_controls(); owned_context_controls(); callable_context_controls(); tuple_context_controls(); tuple_tags_controls(); constructor_registry_controls();
