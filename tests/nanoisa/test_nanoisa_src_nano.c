...
int main(int argc, char **argv) {
    ...
    CHECK(c_one_t && c_one_t->result_tag == TAG_ARRAY,
          "C seed tags one_t as array result");
    CHECK(s_one_t && s_one_t->result_tag == TAG_ARRAY,
          "src_nano tags one_t as array result");
