        ...
        with tempfile.TemporaryDirectory(prefix='nano-profiles-') as tmp:
            ...
            for name, (assembly, general, scalar) in cases.items():
                with self.subTest(case=name):
                    ...
                    literal = literal_only or name in ('managed_replace', 'managed_primitive', 'managed_case', 'managed_char', 'managed_trim', 'managed_concat', 'managed_substring', 'managed_decimal', 'managed_format', 'managed_float_format', 'managed_float_parse', 'managed_contains', 'managed_starts', 'managed_ends')
