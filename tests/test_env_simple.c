...
static int64_t nl_main() {
    nl_println_string("=== Testing get_argc/get_argv ===");
    int64_t argc = 0LL;
    /* unsafe */ {
        argc = get_argc();
    }
    nl_print_string("argc: ");
    nl_println_string(int_to_string(argc));
    int64_t i = 0LL;
    while (i < argc)     {
        const char* arg = "";
        /* unsafe */ {
        ...
        nl_print_string("argv[");
        nl_print_string(int_to_string(i));
        nl_print_string("]: ");
        nl_println_string(arg);
        i = (i + 1LL);
    }
    nl_println_string("Test passed!");
    return 0LL;
}
