...
'''+main,['wrap','probe','main'])
        ...
        positives['declared-store']=('fn array_set(rows: array<array<int>>, index: int, words: array<string>) -> int { return (+ index (array_length words)) }\nshadow array_set { assert (== (array_set [[1]] 40 ["a", "b"]) 42) }\nfn probe() -> int { assert (== (array_set [[1]] 40 (str_split "a,b" ",")) 42) return 0 }\nshadow probe { assert (== (probe) 0) }\n'+main,['array_set', 'probe', 'main'])
