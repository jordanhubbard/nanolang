...
class ManagedCore(unittest.TestCase):
    ...
    def wasm_build(self, testing):
        ...
        names = ['nms_core_tests','nms_concat_tests','nms_failure_tests','nms_reuse_tests','nms_pressure_tests'] if testing else ['nms_product_smoke']
...
console.log('I passed two instances, three rounds, five runtime groups.');'''
